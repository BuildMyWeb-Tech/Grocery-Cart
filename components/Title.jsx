// C:\Users\Siddharathan\Desktop\Grocery-Cart\components\Title.jsx
'use client'
        ...
        <div className='flex flex-col items-center'>
            ...
            {visibleButton ? (
                <Link href={href} className='flex items-center gap-5 text-sm text-slate-600 mt-2'>
                    ...
                    <button className='text-green-500 flex items-center gap-1'>View more <ArrowRight size={14} /></button>
                </Link>
            ) : (
