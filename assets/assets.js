// C:\Users\Siddharathan\Desktop\Grocery-Cart\assets\assets.js
...
import { LeafyGreenIcon, TruckIcon, StoreIcon, ShieldCheckIcon } from "lucide-react";
...
export const categories = ["Vegetables", "Fruits", "Organic Products", "Rice & Grains", "Oil & Spices", "Daily Essentials"];

export const dummyRatingsData = [
    { id: "rat_1", rating: 4.2, review: "I was a bit skeptical at first, but this product turned out to be even better than I imagined. The quality feels premium, it's easy to use, and it delivers exactly what was promised. I've already recommended it to friends and will definitely purchase again in the future.", user: { name: 'Kristin Watson', image: profile_pic1 }, productId: "prod_1", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Fresh Tomatoes (1 kg)', category: 'Vegetables', id: 'prod_1' } },
    { id: "rat_2", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Jenny Wilson', image: profile_pic2 }, productId: "prod_2", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Farm Fresh Onions (1 kg)', category: 'Vegetables', id: 'prod_2' } },
    { id: "rat_3", rating: 4.1, review: "This product is amazing. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Bessie Cooper', image: profile_pic3 }, productId: "prod_3", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Royal Gala Apples (1 kg)', category: 'Fruits', id: 'prod_3' } },
    { id: "rat_4", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Kristin Watson', image: profile_pic1 }, productId: "prod_4", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Robusta Bananas (1 dozen)', category: 'Fruits', id: 'prod_4' } },
    { id: "rat_5", rating: 4.3, review: "Overall, I'm very happy with this purchase. It works as described and feels durable. The only reason I didn't give it five stars is because of a small issue (such as setup taking a bit longer than expected, or packaging being slightly damaged). Still, highly recommend it for anyone looking for a reliable option.", user: { name: 'Jenny Wilson', image: profile_pic2 }, productId: "prod_5", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Organic Spinach Bunch', category: 'Organic Products', id: 'prod_5' } },
    { id: "rat_6", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Bessie Cooper', image: profile_pic3 }, productId: "prod_6", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Organic Carrots (500 g)', category: 'Organic Products', id: 'prod_6' } },
]
...
export const dummyStoreData = {
    ...
    userId: "user_1",
    name: "Happy Shop",
    description: "At Happy Shop, we believe in delivering fresh, quality groceries right to your doorstep. From farm-fresh vegetables and fruits to pantry essentials, oils, and organic produce — find everything you need for your kitchen, all in one place.",
    username: "happyshop",
...
export const productDummyData = [{
        ...
        description: "Juicy, vine-ripened tomatoes hand-picked from local farms. Perfect for curries, salads, and everyday cooking, sourced fresh daily to guarantee the best taste and texture.",
        mrp: 45,
        price: 35,
    ...
    {
        id: "prod_2",
        name: "Farm Fresh Onions (1 kg)",
        description: "Firm, flavorful onions grown by trusted local farmers. A kitchen staple that adds depth to every dish, freshly packed to lock in flavor.",
        mrp: 40,
        price: 30,
        images: [product_img2],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Crisp, naturally sweet apples picked at peak ripeness. A healthy snack or a great addition to your fruit basket, sourced from trusted orchards.",
        mrp: 220,
        price: 180,
        images: [product_img3],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Naturally ripened, energy-packed bananas delivered fresh from local farms. A perfect everyday fruit for the whole family.",
        mrp: 60,
        price: 45,
        images: [product_img4],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Pesticide-free, farm-grown spinach packed with nutrients. Freshly harvested and delivered quickly to preserve its crisp texture and rich color.",
        mrp: 35,
        price: 25,
        images: [product_img5],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Sweet, crunchy organic carrots grown without synthetic pesticides. Great for juicing, cooking, or snacking straight from the bag.",
        mrp: 50,
        price: 40,
        images: [product_img6],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Long-grain, aromatic basmati rice sourced from trusted mills. Cooks up light and fluffy, perfect for everyday meals and special occasions alike.",
        mrp: 650,
        price: 549,
        images: [product_img7],
        storeId: "seller_1",
    ...
    {
        id: "prod_8",
        name: "Whole Wheat Flour (5 kg)",
        description: "Stone-ground whole wheat flour milled for freshness and nutrition. Ideal for soft, wholesome rotis and breads every day.",
        mrp: 280,
        price: 240,
        images: [product_img8],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Light, healthy sunflower oil refined for everyday cooking. Low in saturated fat and perfect for frying, sautéing, and baking.",
        mrp: 180,
        price: 159,
        images: [product_img9],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Pure, finely ground turmeric sourced from trusted spice farms. Adds rich color and authentic flavor to every dish.",
        mrp: 90,
        price: 75,
    ...
    },
    {
        id: "prod_11",
        name: "Toned Milk (1 L)",
        description: "Fresh, pasteurized toned milk delivered daily from trusted local dairies. A wholesome addition to your everyday essentials.",
        mrp: 64,
        price: 58,
    ...
    },
    {
        ...
        description: "Clean, finely refined sugar for all your everyday cooking and baking needs. Packed fresh to maintain quality and purity.",
        mrp: 55,
        price: 48,
...
export const ourSpecsData = [
    { title: "Farm Fresh Products", description: "Fresh vegetables and fruits sourced from trusted stores.", icon: LeafyGreenIcon, accent: '#16A34A' },
    { title: "Fast Delivery", description: "Get your groceries delivered quickly and efficiently.", icon: TruckIcon, accent: '#22C55E' },
    { title: "Trusted Local Stores", description: "Shop confidently from verified grocery sellers.", icon: StoreIcon, accent: '#15803D' },
    { title: "Secure Payments", description: "Safe and secure online transactions.", icon: ShieldCheckIcon, accent: '#166534' }
]
...
export const storesDummyData = [{
        ...
        name: "GreatStack",
        description: "GreatStack is a trusted local grocery store bringing fresh vegetables, fruits, and everyday essentials to your doorstep at honest prices.",
        username: "greatstack",
